...
instr(H, 'plosk_chist'):-   opora_sfer(Code_op, DM),
                            ...
                            countHead(List),
                            write_instr('plosk_chist', Code_op, false, Code_kul, Code_zaj).

instr(H, 'plosk_chern'):-   opora_nasechka(Code_op, DM),
                            kulachok_rezb(Code_kul, TR_kul, DM, H_kul),
                            zajim(Code_zaj, TR_zaj, TR_kul, H_zaj),
                            H_pr is H-(H_kul+H_zaj+30),
                            H_pr > 0,
...
% «аготовки с цилиндрической наружной поверхностью
instr(H, 'cyl_vert', D):-   kulachok_prizm_vert(Code_kul, TR_kul, H_kul, D),
                            ...
                            prokl_compl(H_pr, TR_zaj, N, List),
                            countHead(List),
                            write_instr('cyl_vert', false, false, Code_kul, Code_zaj).

instr(H, 'cyl_gor', D):-    kulachok_prizm_gor(Code_kul, TR_kul, H_kul, D),
                            zajim(Code_zaj, TR_zaj, TR_kul, H_zaj),
                            H_pr is H-(H_kul+H_zaj+30),
                            H_pr > 0,
                            write('Sum H_pr: '), write(H_pr), nl,
...
% «аготовки со специальными технологическими отверсти€ми
